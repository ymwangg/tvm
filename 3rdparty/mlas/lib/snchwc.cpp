...
--*/
{
    ...
    WorkBlock.tids = MlasGetMaximumThreadCount();

    MlasExecuteThreaded(ThreadedRoutine, &WorkBlock, WorkBlock.tids);
}
...
--*/
{
    ...
    MlasExecuteThreaded(MlasNchwcThreaded<MLAS_NCHWC_POOL_ALGORITHM>, &WorkBlock, WorkBlock.tids);
}
